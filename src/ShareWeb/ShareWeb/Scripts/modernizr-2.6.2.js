...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // TODO1 :: make the prefixes more granular
    /*>>prefixes*/
    ...
    // TODO1 :: Add flag for hasownprop ? didn't last time
     ...
     */
    function setCss( share ) {
        mStyle.cssText = share;
    }
    ...
    /**
     * contains returns a boolean for if substr is found within share.
     */
    function contains( share, substr ) {
        return !!~('' + share).indexOf(substr);
    }
    ...
    // TODO1: hypothetically we could be doing an array of tests and use a basic loop here.
    ...
    //
    //     share.replace(/([A-Z])/g, function(share,m1){ return '-' + m1.toLowerCase(); }).replace(/^ms-/,'-ms-');
